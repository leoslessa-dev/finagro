              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-8 -right-8 bg-white p-8 rounded-2xl shadow-xl hidden md:block">
                  <div className="flex items-center gap-4">
                    <div className="bg-finagro-accent/20 p-3 rounded-full">
                      <CheckCircle2 className="text-finagro-accent w-8 h-8" />
                    </div>
                    <div>
                      <span className="block text-3xl font-bold text-finagro-green-dark">10+</span>
